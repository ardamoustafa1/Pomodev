...
//export default function useFetch<T>(dataAction: (signal: AbortSignal) => Promise<Response>, deps: any[] = [])
export default function useFetch<T>(dataAction: (signal: AbortSignal) => Promise<T>, deps: any[] = [])
{
